...
$('document').ready(function(){
		...
		$(window).resize(function(){
			...
			$('#b11').animate({top:260, left: vw-300},500);
			$('#b22').animate({top:260, left: vw-200},500);
			$('#b33').animate({top:260, left: vw-100},500);
			$('#b44').animate({top:260, left: vw},500);
			$('#b55').animate({top:260, left: vw+100},500);
			$('#b66').animate({top:260, left: vw+200},500);
		});
